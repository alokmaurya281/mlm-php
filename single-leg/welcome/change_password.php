...
$sql=mysqli_query($con,"SELECT * FROM users WHERE password='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$uid=$_SESSION['userid'];
$newpass=($_POST['newpass']);
 $ret=mysqli_query($con,"update users set password='$newpass' where userid='$uid'");
                  ...
                  <div class="card-body">
                    ...
                    <p style="color:#F00"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']="";?></p>
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="confirmpassword" value="" placeholder="Enter Password again" required>
                      </div>
