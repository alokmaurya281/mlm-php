...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from users where userid='$adminid'");
if($msg)
{
          ...
          <div id="sidebar"  class="nav-collapse ">
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                   ...
                   <li class="mt">
                      <a href="income_recieved.php">
                          <i class="fa fa-file"></i>
                          <span>Income recieveed</span>
                      </a>
                  </li>
			<li class="mt">
                      <a href="data_summary.php">
                          <i class="fa fa-file"></i>
...
<li class="mt">
                  ...
                  <li class="mt">
                      <a href="update_daily_income.php">
                          <i class="fa fa-file"></i>
                          <span>Update Daily Income</span>
                      </a>
                  </li>
