...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update users set name='$name', sponserid='$sponserid', email='$email' , password='$password' , account_status='$account_status', contactno='$contact' where userid='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from users where userid='".$_GET['uid']."'");
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                               ...
                               <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Sponser Id </label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="sponserid" value="<?php echo $row['sponserid'];?>" >
                              </div>
                          </div>
                          </div>
                               <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="regdate" value="<?php echo $row['date_time'];?>" readonly >
                              </div>
                          </div>
